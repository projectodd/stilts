...
public class JMSStompServer extends AbstractStompServer<JMSClientAgent> {
    
    public JMSStompServer() {
        
    }
    
    public JMSStompServer(Authenticator authenticator, DestinationMapper destinationMapper) {
        super( authenticator );

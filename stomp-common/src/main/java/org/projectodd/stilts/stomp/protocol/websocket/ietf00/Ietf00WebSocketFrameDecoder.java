 ...
 */
public class Ietf00WebSocketFrameDecoder extends ReplayingDecoder<VoidEnum> {

    public static final int DEFAULT_MAX_FRAME_SIZE = 16384;

    private final int maxFrameSize;

    public Ietf00WebSocketFrameDecoder() {
     ...
     */
    public Ietf00WebSocketFrameDecoder(int maxFrameSize) {
    ...
    private Logger log = Logger.getLogger( "stilts.websockets.ietf00.decoder" );
}

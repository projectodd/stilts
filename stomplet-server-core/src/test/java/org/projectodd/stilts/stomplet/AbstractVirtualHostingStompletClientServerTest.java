...
public abstract class AbstractVirtualHostingStompletClientServerTest extends AbstractStandaloneClientServerTest<VirtualHostingStompletCircusServer> {

    @Override
    public StandaloneCircusServer<VirtualHostingStompletCircusServer> createServer() throws Exception {
        VirtualHostingStompletCircusServer server = new VirtualHostingStompletCircusServer();

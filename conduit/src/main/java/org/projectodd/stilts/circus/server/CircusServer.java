 ...
 */
public class CircusServer<T extends MessageConduitFactory> extends SimpleStompServer<CircusStompProvider> {
    ...
    public void start() throws Throwable {
        CircusStompProvider provider = new CircusStompProvider( this.transactionManager, getXAMessageConduitFactory() );
